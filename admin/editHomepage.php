...
include("session_check.php");
	...
	if($_POST['Submit']){
		...
		$sql="Update mobilemanager_moSiteInfo set homepageText='$homeText' where siteId='$siteId'";
		mysql_query($sql);	
		if ($returnHome=="true") {
	...
	$sqlu="SELECT SiteName, homepageText FROM ".$projectName."moSiteInfo WHERE siteId=$siteId";
...
else
{
	var editor = CKEDITOR.replace( 'PostArea' ,{
                <?  $sql="SELECT usertype FROM ".$projectName."moSiteInfo WHERE siteId=$siteId";
