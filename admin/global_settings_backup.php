...
<div id="designed">
     <ul>
         <li><a href="#first-tab"><span>General Info</span></a></li>
         <li><a href="#second-tab"><span>Logo Informtion</span></a></li>
         <li><a href="#third-tab"><span>Naviation</span></a></li>
     </ul>
...
<table cellpadding="10" cellspacing="10" align="left">
	<tr>
    	<td style="border-right: thick solid #ed9601"><form name="form_global_settings" enctype="multipart/form-data" action="global_settings.php" method="post" >     
        <table border="0" cellpadding="10" cellspacing="10" class="generaltable">        
        <tr>
            <td colspan="2" class="adminHeader"><h3>Logo Information</h3></td>
        </tr>
        <tr>
            <td colspan="2">
            	<h3>Logo:</h3>
        ...
        <tr>
            <td colspan="2" class="adminHeader"><h3>Choose A Layout (Beta)</h3> </td>
        </tr>
        <tr>
            <td colspan="2">
    	...
    	<tr>
            <td colspan="2" class="adminHeader"><h3>Add a Background Image</h3> </td>
        </tr>
    <tr>
    ...
    <? } ?>
        ...
        <tr>
            <td colspan="2" class="adminHeader"><h3>Choose your Mobile Navigation Style</h3></td>
        </tr>
        <tr>
            <td colspan="2">
                <table>
        ...
        <tr>
            <td colspan="2"  class="adminHeader"><h3>Edit Your CSS Style</h3></td>
        <tr>
        <tr>
    ...
    <tr><td colspan="2" align="center"><input type="submit" class="formButton" name="submit" id="submit" value="Save" /></td></tr>
    </table>
    </form>
</td>
    	<td valign="top"><div id="Table_01">
	<div id="iphoneViewer_">
		<img id="iphoneViewer" src="images/iphoneViewer.gif" width="370" height="143" alt="" />
	</div>
	<div id="iphoneViewer002_">
		<img id="iphoneViewer002" src="images/iphoneViewer-02.gif" width="24" height="573" alt="" />
	</div>
	<div id="iphoneViewer003">
    ...
    <h1 style="text-align: center;"><?php if($logoOrcompany['Logo']!='')
				          { 
						  $src="logo/".$logoOrcompany['Logo'];
						  ?>
			<img  src="/<?=$src?>" alt="Logo"  height="<?= $logoOrcompany['logoHeight']; ?>" width="<?= $logoOrcompany['logoWidth']; ?>" />
                          
						  <?php } else echo $logoOrcompany['Company']; ?>
						  <!--Home page of --> <? //=$userName?>
            <p>
            <!--a href="#home" class="back" target="_self"><img src="images/icons/back_icon.png" /></a> <a href="#home" target="_self"><img src="images/icons/home_icon.png" /></a--> <a href="tel:<?= $logoOrcompany['bizPhone']; ?>" class="flip" target="_webapp"><img src="/images/icons/phone_icon.png" /></a> <a href="mailto:<?= $logoOrcompany['bizEmail']; ?>" class="flip" target="_webapp"><img src="/images/icons/mail_icon.png" /></a>
            <!--br />
<strong class="socialShare">
    ...
    <script type="text/javascript" src="http://tweetmeme.com/i/scripts/button.js"></script>
            ...
            <div>
        <form method="post" id="searchBoxBG1" action="searchPage.php">
          <div>
          	<input name="searchWord" id="searchWord" type="text" value=" " size="20" autocorrect />
...
<?
$query9="SELECT * FROM ".$projectName."page x, ".$projectName."user y WHERE x.Userid=y.Userid and y.Username='$userName'";

	$result9=mysql_query($query9);
	$row9=mysql_fetch_array($result9);
//while($row9=mysql_fetch_array($result9)) { ?>
				<div id="m3link"><a id="linkColor" href="#page<?=$row9['pageid']?>"><?=$row9['Pagetitle']?></a></div>
				<div id="m3link2"><a id="linkColor2" href="<?= $logoOrcompany['bizWebsite']; ?>/index.php?mobileWeb=no">Desktop Site</a></div>
	...
	<div id="iphoneViewer004_">
		<img id="iphoneViewer004" src="images/iphoneViewer-04.gif" width="26" height="573" alt="" />
	</div>
	<div id="iphoneViewer005_">
		<img id="iphoneViewer005" src="images/iphoneViewer-05.gif" width="320" height="155" alt="" />
	</div>
</div>
</td>
    </tr>
