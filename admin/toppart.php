<?php
	...
	$sqlp = "SELECT Pagetitle, Seourl FROM mobilemanager_page WHERE moSiteId = ". $curMobiId;
...
<!--script type="text/javascript" src="/scripts/jquery-ui-personalized-1.6rc6.js"></script-->
	<script src="adminHeaderFiles/javascript/jquery.tools.min.js"></script>
<script type="text/javascript" src="/scripts/jquery-ui-1.7.1.custom.min.js"></script>
	<link rel="stylesheet" type="text/css" href="adminHeaderFiles/css/tabs.css" />
	<style>
.panes .hide {
	display:none;		
	padding:15px 10px;
...
<? if ($curMobiId != "") { ?>       
	...
	<a href="allGalleries.php">Galleries</a>	 | 
<?PHP 
	if ($Userid == '93') {
?>		
