...
<html>
    ...
    <body>
    	<form action="extensionCheck.php" method="post">
        	<table>
            	<tr>
                	<td>Homepage File Name</td>
                	<td><input type="text" name="dhp" id="dhp" /></td>
                </tr>
            	<tr>
                	<td colspan="2">
        ...
        <pre>
        <?php 
		$code = "if ($_SESSION['m3Mobile'\] == 'yes' OR $_SESSION\['m3Mobile'\] == \"\"  ) {
		...
		?>
        <table width="400px" cellpadding="10" cellspacing="10">
        <tr>
        	<td>&lt;? <?php	
		echo $code;
		?>?&gt;
