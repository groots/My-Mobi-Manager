...
1. Go to the google analytics input setting page which is under the setting menu in the wordpress admin
1. Add your google analytics ID there. An example your google analytics ID --> UA-0000000-0.
1. Save it & your done.
