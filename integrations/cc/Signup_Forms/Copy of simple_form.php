...
<div style="float: right; text-align: left; overflow: auto; height: 290px; width:250px;">
...
<div>
	...
	<table width="550" border="0" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td align="left"><input type="text" name="email_address" value="<?php  echo htmlspecialchars($_POST['email_address'], ENT_QUOTES, 'UTF-8') ?>" maxLength="50" /></td>
