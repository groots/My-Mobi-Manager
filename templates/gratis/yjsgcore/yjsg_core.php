...
require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_modulestyle.php");
...
if( is_array( $define_itemid ) && in_array($itemid, $define_itemid) ){
	require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_mgwidthsitem.php");
}else{
	require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_mgwidths.php");
}
...
//TOP MENU 
    require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_stylesw.php");	
...
require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_fontapi.php");
require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_scripts.php");
require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_links.php");
...
require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_custom_params.php");
?>