...
if ($selectors_override_type == 1 ){ // CSS
	require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_cssfonts.php");
	$nice_font   =  $css_font_family;
	$font_sheet ='';
}elseif ($selectors_override_type == 2){ // GOOGLE
	require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_googlefonts.php");
	...
	require( YJ_TEMPLATEPATH.DS."yjsgcore/yjsg_cufonfonts.php");
